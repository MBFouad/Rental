# Property Units Management System

## Project Overview
Bilingual (Arabic/English) Laravel 12 application for managing property units with Filament admin panel.
...
| Field | Type | Notes |
|-------|------|-------|
| type | enum | rental, sale, under_construction |
| title | json | Translatable (ar/en) |
| description | json | Translatable (ar/en) |
| location | json | Translatable (ar/en) |
| status | enum | available, reserved, sold, rented |

### Type-Specific Tables
- **rental_details**: monthly_rent, insurance_amount
- **sale_details**: sale_price, is_negotiable
- **construction_details**: down_payment_amount, down_payment_percentage
- **payment_plans**: duration_years (3/5/10), monthly_installment
...
### Translations
- Arabic is default language (`APP_LOCALE=ar`)
- Use `HasTranslations` trait on models
- Translatable fields stored as JSON

### RTL Support
- HTML `dir` attribute set by locale
- Use Tailwind logical properties (ms-, me-, ps-, pe-)

### Media
- Use Spatie Media Library
- Collections: `images`, `videos`
- Multiple files per unit supported
...
- `/units/rental` - Rental units
- `/units/sale` - Sale units
- `/units/construction` - Under construction
